...
public class Imagens {
    ...
    public Imagens(){
        ...
        comojogar1 = new ImageIcon("lib\\imgPtBr\\comoJogarTelaInicial.jpg");
        
        comojogar2 = new ImageIcon("lib\\imgPtBr\\comoJogar2.jpg");
        comojogar3 = new ImageIcon("lib\\imgPtBr\\comoJogar3.jpg");
        comojogar4 = new ImageIcon("lib\\imgPtBr\\comoJogar4.jpg");
        comojogar5 = new ImageIcon("lib\\imgPtBr\\comoJogar5.jpg");
        comojogar6 = new ImageIcon("lib\\imgPtBr\\comoJogar6.jpg");
        comojogar7 = new ImageIcon("lib\\imgPtBr\\comoJogar7.jpg");
        comojogar8 = new ImageIcon("lib\\imgPtBr\\comoJogar8.jpg");

        comojogar = new ImageIcon[]{comojogar1, comojogar2, comojogar3, comojogar4, comojogar5, comojogar6, comojogar7, comojogar8};
        batalha = new ImageIcon("lib\\imgPtBr\\Bataalha.jpg");
        corDoFundo = new Color(7,8,28);
        // fundo = new ImageIcon("lib\\Untitled-1.jpg");
        botaoSair = new ImageIcon("lib\\imgPtBr\\BotaoSair.png");
        botaoProximo = new ImageIcon("lib\\imgPtBr\\BotaoProximo.png");
        botaoSalvar = new ImageIcon("lib\\imgPtBr\\BotaoSalvar.png");
        botaoCarregar = new ImageIcon("lib\\imgPtBr\\carregarJogo.png");
        botaoNovoJogo = new ImageIcon("lib\\imgPtBr\\novoJogoButton.png");
        botaoComoJogar = new ImageIcon("lib\\imgPtBr\\comoJogarButton.png");
        botaoProsseguir = new ImageIcon("lib\\imgPtBr\\BotaoProsseguir.png");
